    ...
    <>
      <article className={styles.widget} data-widget={type} data-valid={connected}>
        ...
        <div className={styles.cardArrow}>
          <div className={styles.cardArrowTopLeft}></div>
          <div className={styles.cardArrowTopRight}></div>
          <div className={styles.cardArrowBottomLeft}></div>
          <div className={styles.cardArrowBottomRight}></div>
        </div>
