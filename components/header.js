          ...
          <div className={styles.addbar}>
            <div className={styles.navbar_left}>
              <h2 className={styles.logo}>
                  {/* <Image layout="fixed" src={Logo} priority="true" alt="QATAR" width="70" /> */}
                  <img layout="fixed" src="/logo.png" priority="true" alt="QATAR" width="70" />
                  <p>Qatar World Cup 2022</p>
              </h2>
              <div className={styles.links}>
                <span className={true ? styles.active : ''}><FaChartPie /> <p>Pools</p></span>
                <span className={true ? styles.active : ''}><IoMdFootball /> <p>Sports</p></span>
                <span className={true ? styles.active : ''}><GiAchievement /><p>Leaderboard</p></span>
              </div>
            </div>
